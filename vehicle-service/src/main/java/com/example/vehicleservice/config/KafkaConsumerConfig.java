...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Location> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "vehicle-group");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);

        JsonDeserializer<Location> deserializer = new JsonDeserializer<>(Location.class);
        deserializer.addTrustedPackages("*"); // confiance à tous les packages
        deserializer.ignoreTypeHeaders();     // ignore l'en-tête __TypeId__ du Producer
